...
Route::get('jadwal_matakuliah/simpan','jadwalmatakuliah_controller@simpan');
Route::get('jadwal_matakuliah/{jadwalmatakuliah}','jadwal_matakuliahcontroller@lihat');
Route::get('jadwal_matakuliah/edit/{jadwalmatakuliah}','jadwalmatakuliahcontroller@edit');
Route::get('jadwal_matakuliah/edit/{jadwalmatakuliah}','jadwal_matakuliahcontroller@update');
Route::get('jadwal_matakuliah/hapus/{jadwalmatakuliah}','jadwalmatakuliahcontroller@hapus');
//==============================================================
